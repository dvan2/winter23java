...
class Project3IT extends InvokeMainTestCase {
  ...
  void notEnoughArgumentsWithPrintAndReadme(){
    ...
    void xmlAndtextFileThrowsException (){
        MainMethodResult result = invokeMain(Project3.class  ,"-textFile", "airline.txt", "-xmlFile", "bad.xml","-pretty" , "prettyTest1.txt", "Delta", "123", "PDX", "12/12/2000","12:12", "PM", "PDX", "03/03/2023", "12:12", "AM");
    ...
    @Test
    void noXmlFile(){
        MainMethodResult result = invokeMain(Project3.class , "-xmlFile");
    ...
    void unknownCommandThrowsException() {
        MainMethodResult result = invokeMain(Project3.class  ,"-hi", "airline.txt", "-xmlFile", "bad.xml","-pretty" , "prettyTest1.txt", "Delta", "123", "PDX", "12/12/2000","12:12", "PM", "PDX", "03/03/2023", "12:12", "AM");
    ...
    @Test
    void xmlFilePresent() {
        MainMethodResult result = invokeMain(Project3.class  ,"-xmlFile", "xdump.xml", "Delta", "123", "PDX", "12/12/2000","12:12", "PM", "PDX", "03/03/2023", "12:12", "AM");
    ...
    @Test
    void validDateFail() {
        MainMethodResult result = invokeMain(Project3.class , "Delta", "123", "PDX", "12/12/2000","12:12", "PM", "PDX", "03/03", "12:12", "AM");
    ...
    @Test
    void timeMalformed() {
        MainMethodResult result = invokeMain(Project3.class , "Delta", "123", "PDX", "12/12/2000","12:12:1", "PM", "PDX", "03/03", "12:12", "AM");
